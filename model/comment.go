...
type Comment struct {
	...
	SwapiMovieID int            `json:"movie_id" gorm:"column:swapi_movie_id;not null;comment:'id of movie from www.swapi.dev'"`
	...
	DeletedAt    gorm.DeletedAt `json:"-" gorm:"column:deleted_at" swaggerignore:"true"`
}
